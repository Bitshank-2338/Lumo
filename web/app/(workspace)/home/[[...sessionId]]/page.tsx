...
import LumoLaunchpad from "@/components/chat/home/LumoLaunchpad";
        ...
        >
          ...
          <div className="flex w-full flex-1 min-h-0 flex-col">
            {sessionLoading ? (
              ...
              <div className="relative flex w-full flex-1 min-h-0 items-end justify-center overflow-hidden px-6 pb-10 animate-fade-in">
                <div className="pointer-events-none absolute inset-x-0 bottom-0 mx-auto h-72 max-w-4xl bg-[radial-gradient(circle_at_center,var(--primary),transparent_67%)] opacity-[0.055] blur-3xl" />
                <div className="relative flex w-full max-w-[960px] flex-col items-center gap-7">
                  <div className="flex items-center justify-center gap-4 text-center">
                    <Image
                      ...
                      width={44}
                      height={44}
                      className="h-11 w-11 select-none rounded-2xl shadow-sm"
                    />
                    <div className="text-left">
                      <p className="mb-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-[var(--primary)]">
                        {t("Lumo · Learn with direction")}
                      </p>
                      <h1 className="font-serif text-[34px] font-medium leading-[1.1] tracking-[-0.02em] text-[var(--foreground)] sm:text-[40px]">
                        {t(welcomeGreeting)}
                      </h1>
                    </div>
                  </div>
                  <LumoLaunchpad onPrompt={handlePrefillComposer} />
                </div>
              </div>
            ) : (

...
export const metadata: Metadata = {
  title: {
    default: "Lumo — learn with direction",
    template: "%s · Lumo",
  },
  description:
    "An agent-native learning companion for understanding, planning, researching, and creating.",
  icons: {
    icon: [{ url: "/lumo-mark.svg", type: "image/svg+xml" }],

...
const RELEASES_URL = process.env.NEXT_PUBLIC_LUMO_GITHUB_URL
  ? `${process.env.NEXT_PUBLIC_LUMO_GITHUB_URL.replace(/\/$/, '')}/releases`
  : 'https://github.com/Bitshank-2338/Lumo/releases'

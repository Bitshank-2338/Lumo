  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        href: "/space/skills",
        icon: Wand2,
        title: { zh: "Lumo 技能库", en: "Lumo Skill Library" },
        blurb: {
          zh: "面向学习、研究、规划与创作的可复用能力手册。",
          en: "Reusable playbooks for learning, research, planning, and creation.",
        },
    ...
    <div>
      <header className="mb-8">
        <h1 className="font-serif text-[24px] font-semibold leading-tight tracking-tight text-[var(--foreground)]">
          {tr({ zh: "Lumo 学习空间", en: "Lumo Learning Space" })}
        </h1>
        <p className="mt-1.5 max-w-xl text-[13px] leading-relaxed text-[var(--muted-foreground)]">
          {tr({
            zh: "你的对话、智能体、笔记与练习，集中在一处 —— 从这里进入。",
            en: "Your conversations, mastery paths, skills, notebooks, and connected agents — organized around progress.",
          })}
        </p>
      </header>

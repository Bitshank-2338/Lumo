...
LABELS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "lab": "Built on DeepTutor · Data Intelligence Lab @ HKU",
        # init
        ...
        "init.next_step": "Run `deeptutor start` to launch Lumo.",
        "init.choice": "Choice",
        ...
        "start.port_in_use": (
            "Lumo cannot start because port(s) already in use: {ports}. "
    ...
    "zh": {
        "tagline": "智能体原生的个性化辅导",
        "lab": "基于 DeepTutor 构建 · 香港大学数据智能实验室",
        # init
        "init.mode": "工作目录初始化",
        "init.workspace": "工作目录",
        ...
        "init.next_step": "运行 `deeptutor start` 启动 Lumo。",
        "init.choice": "请选择",

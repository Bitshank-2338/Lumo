---
name: skill-creator
description: Design and author Lumo skills (SKILL.md packages). Use when the user wants to create a new skill, improve an existing skill, or asks how Lumo's skill library works.
---

# Skill Creator

Guidance for authoring effective Lumo skills.
